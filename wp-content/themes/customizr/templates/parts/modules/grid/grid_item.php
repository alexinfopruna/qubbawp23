 ...
 */
?>
<article id="post-zzz" class="grid-item col-12 col-md-6 col-xl-4 
col-lg-4 post-zzz post type-post status-publish format-standard 
has-post-thumbnail category-equipament czr-hentry" a=2 
data-czr-model_id="grid_item" 
data-czr-template="templates/parts/modules/grid/grid_item">

<!--<article <?php czr_fn_echo( 'article_selectors' ) ?> a=2 <?php 
czr_fn_echo('element_attributes') ?>> -->
